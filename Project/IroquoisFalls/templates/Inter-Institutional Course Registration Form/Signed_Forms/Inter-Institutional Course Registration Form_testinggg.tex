...
\end{tabular} & \begin{tabular}{p{2cm}}
...
\begin{center}
    \textbf{\footnotesize Name:} \TextField[name=fullname, width=9cm]{first_name}
    \hrulefill 
    \hspace{1cm} 
...
\newline
Student Signature:
\IfFileExists{../../Signatures/signature_testinggg.png}{%
  \noindent
  \raisebox{-0.1\height}{\includegraphics[width=0.3\textwidth, height=2cm]{../../Signatures/signature_testinggg.png}}
