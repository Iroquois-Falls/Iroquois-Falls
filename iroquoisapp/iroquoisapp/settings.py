"""
Django settings for iroquoisapp project.
...
SECRET_KEY = "django-insecure-u7(*np=y7(x52r*#d!_!*7w4+_8v)tpm3782_993)#_a9(d%p1"
...
WSGI_APPLICATION = "iroquoisapp.wsgi.application"
